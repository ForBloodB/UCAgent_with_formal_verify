...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [31:0] _T_127 = io__in_bits_req_addr ^ 32'h30000000; // @[NutCore.scala 78:11]
  wire  _T_129 = _T_127[31:28] == 4'h0; // @[NutCore.scala 78:44]
  wire [31:0] _T_130 = io__in_bits_req_addr ^ 32'h40000000; // @[NutCore.scala 78:11]
  wire  _T_132 = _T_130[31:30] == 2'h0; // @[NutCore.scala 78:44]
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  _T_11 = s2_io__out_bits_req_cmd == 4'h4; // @[SimpleBus.scala 80:26]
  wire  _T_12 = s3_io__in_bits_req_cmd == 4'h4; // @[SimpleBus.scala 80:26]
  wire  _T_14 = ~s2_io__in_valid; // @[Cache.scala 544:15]
  wire  _T_15 = ~s3_io__in_valid; // @[Cache.scala 544:34]
  wire  _T_17 = s3_io__out_bits_cmd == 4'h4; // @[SimpleBus.scala 95:26]
  wire  _T_18 = s3_io__out_valid & _T_17; // @[Cache.scala 546:43]
  wire  _T_19 = s3_io__out_valid | s3_io__dataReadRespToL1; // @[Cache.scala 546:100]
  ...
  assign io_in_resp_valid = _T_18 ? 1'h0 : _T_19; // @[Cache.scala 540:14 Cache.scala 546:20]
  ...
  assign io_empty = _T_14 & _T_15; // @[Cache.scala 544:12]
  ...
  assign s3_io__in_valid = _T_7; // @[Pipeline.scala 31:17]
  assign s3_io__in_bits_req_addr = _T_10_req_addr; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_req_cmd = _T_10_req_cmd; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_0_tag = _T_10_metas_0_tag; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_0_valid = _T_10_metas_0_valid; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_0_dirty = _T_10_metas_0_dirty; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_1_tag = _T_10_metas_1_tag; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_1_valid = _T_10_metas_1_valid; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_1_dirty = _T_10_metas_1_dirty; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_2_tag = _T_10_metas_2_tag; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_2_valid = _T_10_metas_2_valid; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_2_dirty = _T_10_metas_2_dirty; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_3_tag = _T_10_metas_3_tag; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_3_valid = _T_10_metas_3_valid; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_metas_3_dirty = _T_10_metas_3_dirty; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_hit = _T_10_hit; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_waymask = _T_10_waymask; // @[Pipeline.scala 30:16]
  assign s3_io__in_bits_mmio = _T_10_mmio; // @[Pipeline.scala 30:16]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _T_7 = _RAND_3[0:0];
  _RAND_4 = {1{`RANDOM}};
  _T_10_req_addr = _RAND_4[31:0];
  _RAND_5 = {1{`RANDOM}};
  _T_10_req_cmd = _RAND_5[3:0];
  _RAND_6 = {1{`RANDOM}};
  _T_10_metas_0_tag = _RAND_6[23:0];
  _RAND_7 = {1{`RANDOM}};
  _T_10_metas_0_valid = _RAND_7[0:0];
  _RAND_8 = {1{`RANDOM}};
  _T_10_metas_0_dirty = _RAND_8[0:0];
  _RAND_9 = {1{`RANDOM}};
  _T_10_metas_1_tag = _RAND_9[23:0];
  _RAND_10 = {1{`RANDOM}};
  _T_10_metas_1_valid = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  _T_10_metas_1_dirty = _RAND_11[0:0];
  _RAND_12 = {1{`RANDOM}};
  _T_10_metas_2_tag = _RAND_12[23:0];
  _RAND_13 = {1{`RANDOM}};
  _T_10_metas_2_valid = _RAND_13[0:0];
  _RAND_14 = {1{`RANDOM}};
  _T_10_metas_2_dirty = _RAND_14[0:0];
  _RAND_15 = {1{`RANDOM}};
  _T_10_metas_3_tag = _RAND_15[23:0];
  _RAND_16 = {1{`RANDOM}};
  _T_10_metas_3_valid = _RAND_16[0:0];
  _RAND_17 = {1{`RANDOM}};
  _T_10_metas_3_dirty = _RAND_17[0:0];
  _RAND_18 = {1{`RANDOM}};
  _T_10_hit = _RAND_18[0:0];
  _RAND_19 = {1{`RANDOM}};
  _T_10_waymask = _RAND_19[3:0];
  _RAND_20 = {1{`RANDOM}};
  _T_10_mmio = _RAND_20[0:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`ifdef FIRRTL_AFTER_INITIAL
...
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    if (_T_8) begin
      _T_10_req_addr <= s2_io__out_bits_req_addr;
    end
    if (_T_8) begin
      _T_10_req_cmd <= s2_io__out_bits_req_cmd;
    end
    if (_T_8) begin
      _T_10_metas_0_tag <= s2_io__out_bits_metas_0_tag;
    end
    if (_T_8) begin
      _T_10_metas_0_valid <= s2_io__out_bits_metas_0_valid;
    end
    if (_T_8) begin
      _T_10_metas_0_dirty <= s2_io__out_bits_metas_0_dirty;
    end
    if (_T_8) begin
      _T_10_metas_1_tag <= s2_io__out_bits_metas_1_tag;
    end
    if (_T_8) begin
      _T_10_metas_1_valid <= s2_io__out_bits_metas_1_valid;
    end
    if (_T_8) begin
      _T_10_metas_1_dirty <= s2_io__out_bits_metas_1_dirty;
    end
    if (_T_8) begin
      _T_10_metas_2_tag <= s2_io__out_bits_metas_2_tag;
    end
    if (_T_8) begin
      _T_10_metas_2_valid <= s2_io__out_bits_metas_2_valid;
    end
    if (_T_8) begin
      _T_10_metas_2_dirty <= s2_io__out_bits_metas_2_dirty;
    end
    if (_T_8) begin
      _T_10_metas_3_tag <= s2_io__out_bits_metas_3_tag;
    end
    if (_T_8) begin
      _T_10_metas_3_valid <= s2_io__out_bits_metas_3_valid;
    end
    if (_T_8) begin
      _T_10_metas_3_dirty <= s2_io__out_bits_metas_3_dirty;
    end
    if (_T_8) begin
      _T_10_hit <= s2_io__out_bits_hit;
    end
    if (_T_8) begin
      _T_10_waymask <= s2_io__out_bits_waymask;
    end
    if (_T_8) begin
      _T_10_mmio <= s2_io__out_bits_mmio;
    end
  end
endmodule
module Pr21CacheFormalDut(
  ...
  wire  Cache_clock; // @[Cache.scala 818:35]
  wire  Cache_reset; // @[Cache.scala 818:35]
  wire  Cache_io_in_req_ready; // @[Cache.scala 818:35]
  wire  Cache_io_in_req_valid; // @[Cache.scala 818:35]
  wire [31:0] Cache_io_in_req_bits_addr; // @[Cache.scala 818:35]
  wire [3:0] Cache_io_in_req_bits_cmd; // @[Cache.scala 818:35]
  wire  Cache_io_in_resp_ready; // @[Cache.scala 818:35]
  wire  Cache_io_in_resp_valid; // @[Cache.scala 818:35]
  wire [1:0] Cache_io_flush; // @[Cache.scala 818:35]
  wire  Cache_io_out_mem_req_ready; // @[Cache.scala 818:35]
  wire  Cache_io_out_mem_req_valid; // @[Cache.scala 818:35]
  wire  Cache_io_out_mem_resp_valid; // @[Cache.scala 818:35]
  wire [3:0] Cache_io_out_mem_resp_bits_cmd; // @[Cache.scala 818:35]
  wire  Cache_io_mmio_req_ready; // @[Cache.scala 818:35]
  wire  Cache_io_mmio_req_valid; // @[Cache.scala 818:35]
  wire  Cache_io_mmio_resp_valid; // @[Cache.scala 818:35]
  wire  Cache_io_empty; // @[Cache.scala 818:35]
  wire  Cache_io_in_valid; // @[Cache.scala 818:35]
  wire  Cache_io_out_valid; // @[Cache.scala 818:35]
  wire  Cache__T_11_0; // @[Cache.scala 818:35]
  wire  Cache_io_out_bits_mmio; // @[Cache.scala 818:35]
  wire  Cache__T_12_0; // @[Cache.scala 818:35]
  Cache Cache ( // @[Cache.scala 818:35]
    .clock(Cache_clock),
    .reset(Cache_reset),
    ...
    ._T_11_0(Cache__T_11_0),
    .io_out_bits_mmio(Cache_io_out_bits_mmio),
    ._T_12_0(Cache__T_12_0)
  );
  ...
  assign io_pr21_s2_out_prefetch = Cache__T_11_0; // @[Pr21CacheFormalDut.scala 92:27]
  assign io_pr21_s3_in_valid = Cache_io_in_valid; // @[Pr21CacheFormalDut.scala 93:23]
  assign io_pr21_s3_in_prefetch = Cache__T_12_0; // @[Pr21CacheFormalDut.scala 94:26]
  assign io_pr21_cache_empty = Cache_io_empty; // @[Pr21CacheFormalDut.scala 95:23]
  assign Cache_clock = clock;
  assign Cache_reset = reset;
  assign Cache_io_in_req_valid = io_cpu_req_valid; // @[Cache.scala 824:17]
  assign Cache_io_in_req_bits_addr = io_cpu_req_addr; // @[Cache.scala 824:17]
  assign Cache_io_in_req_bits_cmd = io_cpu_req_cmd; // @[Cache.scala 824:17]
  assign Cache_io_in_resp_ready = io_cpu_resp_ready; // @[Cache.scala 824:17]
  assign Cache_io_flush = io_flush; // @[Cache.scala 823:20]
  ...
  assign Cache_io_mmio_req_ready = io_mmio_req_ready; // @[Cache.scala 825:13]
  assign Cache_io_mmio_resp_valid = io_mmio_resp_valid; // @[Cache.scala 825:13]
endmodule
