...
- PR #21 real Cache formal report: `reports/pr21_real_nutshell_cache_formal.md`
...
| --- | --- | --- | --- | --- |
| PR #21 MMIO prefetch | Real Cache pre FAIL / fixed PASS; compact litmus also FAIL/PASS | Directed test detects buggy | INFRA_FAIL | MMIO prefetch must not flush a pending normal request; formal is now reproduced on real NutShell `nutcore.Cache` generated from PR #21 parent/fixed commits. |
